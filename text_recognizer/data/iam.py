...
def _get_region_from_xml_element(xml_elem: Any, xml_path: str) -> Optional[dict[str, int]]:
    ...
    Args:
        xml_elem (Any): xml element can be a line or word element with x, y, width, and height attributes
        xml_path (str): should be "word/cmp" if xml_elem is a line element, else "cmp"
